...
<div align="left">
  ...
  <p style="color: red">  <form:errors  path="userName" required="required" /></p>
    <label for="usrname">Email id</label>
    <form:input  path="userEmail" required="required" />
     <p style="color: red">  <form:errors  path="userEmail" required="required" /></p>
  
	<label for="usrname">Contact Number</label>
    <form:input  path="userContactNo" required="required" maxlength="10" />
     <p style="color: red">  <form:errors  path="userContactNo" required="required"  /></p>
  
<label for="psw">Password</label>
<form:password  id="psw" name="psw" path="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required="required" />
	 <p style="color: red">  <form:errors  path="password" required="required" /></p>
