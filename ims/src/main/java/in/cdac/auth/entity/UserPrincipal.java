...
public class UserPrincipal extends org.springframework.security.core.userdetails.User  {
	...
	public String toString() {
		return "UserPrincipal [user=" + user + ", getUser()=" + getUser() + ", getAuthorities()=" + getAuthorities()
				...
				+ isAccountNonLocked() + ", isCredentialsNonExpired()=" + isCredentialsNonExpired() + ", hashCode()="
