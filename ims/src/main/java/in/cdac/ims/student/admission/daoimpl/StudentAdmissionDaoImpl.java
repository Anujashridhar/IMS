...
public class StudentAdmissionDaoImpl implements StudentAdmisionDao {
   @Autowired
	...
	public ResultDataMap studentSaveData(StudentRegistrationdetails studentRegstrationDetails) {
		
		result = new ResultDataMap();
		...
		session.save(studentRegstrationDetails);
