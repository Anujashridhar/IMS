        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a onclick="getContent('SiteRegistration')" class="waves-effect waves-dark"><i class="fa fa-desktop"></i>Site Registration</a>
                      <!--  <a href="SiteRegistration" class="waves-effect waves-dark"><i class="fa fa-desktop"></i>Site Registration</a> -->
                    </li>
					<li>
