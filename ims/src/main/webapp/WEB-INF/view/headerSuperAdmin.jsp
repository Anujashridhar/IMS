        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu waves-effect waves-dark" onclick="#"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                     <li>
                        <a class="active-menu waves-effect waves-dark" onclick="getContent('SiteRegistration')"><i class="fa fa-dashboard"></i> Site Registration</a>
                    </li>
                     <!-- <li>
                     ...
                     <li>
                    	<a onclick="getContent('siteTemplateSetup')" class="waves-effect waves-dark"><i class="fa fa-desktop"></i>Site Data</a>
                    	<a href="ChooseTemplate" class="waves-effect waves-dark"><i class="fa fa-desktop"></i>Select Template</a>
                    </li>
                     <li>
